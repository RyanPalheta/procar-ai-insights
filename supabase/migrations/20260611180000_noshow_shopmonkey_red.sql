-- 2026-06-11 (pedido Pro Car, print 10:12): NO-SHOW direto do ShopMonkey.
-- Convenção do calendário da loja: agendamento VERMELHO = faltou/cancelou
-- (no-show). O no_show_leads deixa de vir do status "Faltou agendamento" da
-- Kommo (snapshot que atrasa) e passa a contar os agendamentos vermelhos do
-- ShopMonkey, por data do agendamento — mesma família da Conversão de
-- Agendamento (green ÷ leads). Só os blocos no_show mudam vs 20260611170000.
