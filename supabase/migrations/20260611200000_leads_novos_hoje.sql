-- 2026-06-11 (pedido Pro Car): "Leads Novos (24h)" vira "Leads Novos HOJE" —
-- conta de meia-noite a 23:59 do dia corrente NO FUSO DA LOJA (America/New_York),
-- comparando com ONTEM (dia completo), em vez da janela móvel de 24h.
-- As chaves new_audited_24h/new_audited_24h_previous são MANTIDAS por
-- compatibilidade de API; só a semântica muda (hoje × ontem, dia-calendário).
-- Só esses dois blocos mudam vs 20260611190000.
