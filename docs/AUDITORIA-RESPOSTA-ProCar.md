...
| Ponto da auditoria (texto original) | Ajuste realizado | Status |
|---|---|---|
| **Leads por Língua.** "Muito impreciso. Deve trazer todos os atendimentos de um período e segmentá-los pelos idiomas... inglês, espanhol e português." | Resolvido: o idioma passou a ser **detectado por código** das mensagens do cliente (PT-BR / EN-USA / ES-ES) — no `analyze-lead` (novos) e por um backfill de toda a base. Cobertura subiu para **~77%** dos leads de chat (o restante não tem texto suficiente para inferir). Em 30 dias: EN 373, ES 100, PT 59. | FUNCIONAL |
| **Leads novos (24h) por canal.** "O número de leads novos não bate com o Kommo: o dashboard apontou 16 no dia; a auditoria encontrou 11. A quebra por canal também diverge." | Resolvido: o canal real passou a vir do `source_id` da Kommo (cada fonte mapeada para o canal), acabando com o balde "Outros" (de ~3,7 mil leads para 5). Em 30 dias: WhatsApp 1.797, Telefone 617, Instagram 218, Facebook 88. | FUNCIONAL |
