...
export default function Logs() {
  ...
  const getEventTitle = (eventType: string, functionName: string | null) => {
    const titles: Record<string, string> = {
      ...
      'auto_analysis_failed': 'Auto-Análise Falhou',
      'auto_analysis_triggered': 'Auto-Análise Disparada',
      'ai_rate_limit': 'Rate Limit da IA',
      'ai_auth_error': 'Erro de Autenticação da IA',
      'ai_credits_exhausted': 'Créditos de IA Esgotados',
      'ai_timeout': 'Timeout da IA',
      'ai_gateway_error': 'Erro no Gateway da IA',
