...
export function MagicBentoCard({
  ...
  }, [animateParticles, clearAllParticles, disableAnimations, enableTilt, enableMagnetism, clickEffect, glowColor, enableBorderGlow, enableStars]);

  return (
    <div
      ref={cardRef}
      className={cn(
        'magic-bento-card relative overflow-hidden transition-all duration-300',
