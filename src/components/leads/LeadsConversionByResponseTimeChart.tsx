          ...
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              ...
              <ChartInfoTooltip
                ...
                calculation="o tempo de resposta é quantos minutos passaram entre a 1ª mensagem do cliente e a 1ª resposta do agente, agrupado em faixas (0-15, 15-30, 30-60, 60+ min). A taxa de cada faixa = clientes cujo ORÇAMENTO FOI PAGO na loja (ShopMonkey, ligado ao cliente pelo telefone, pago depois da chegada do lead) dividido pelo total de clientes da faixa, vezes 100."
              />
            </CardTitle>
          </CardHeader>
